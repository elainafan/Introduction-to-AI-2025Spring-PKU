...
hyperparams = {"depth": 25, "purity_bound": 1.2, "gainfunc": "negginiDA"}
...
def buildTree(
    X: np.ndarray, Y: np.ndarray, unused: List[int], depth: int, purity_bound: float, gainfunc: Callable, prefixstr=""
):
    """
    递归构建决策树。
